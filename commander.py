...
# Commander Interface for Kerloud flying rover python API
...
class Commander:
    def __init__(self):
        ...
        self.flyingrover_mode_sub = rospy.Subscriber("gi/flyingrover_mode", String, self.flyingrover_mode_callback)
